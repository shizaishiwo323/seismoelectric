...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{figures/figure1_conceptual_workflow_timescale_separation.png}
\caption{Conceptual workflow and time-scale separation. Reactive transport evolves material properties over dissolution time, whereas the seismoelectric waveform is calculated for each fixed dissolution state over waveform time.}
\label{fig:workflow}
\end{figure}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{figures/figure2_reactive_transport_evolution.png}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{figures/figure3_dynamic_electrokinetic_bridge.png}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{figures/figure4a_conversion_coefficients_time.png}
\vspace{0.5em}
\noindent\includegraphics[width=\textwidth]{figures/figure4b_conversion_frequency_angle_heatmaps.png}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{figures/figure5_finite_offset_waveform_panels.png}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{figures/figure6_spatial_peak_dipole_interpretation.png}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{figures/figure7_mechanism_decomposition.png}
...
\begin{figure}
\noindent\includegraphics[width=\textwidth]{figures/figure8_normalized_monitoring_metrics.png}
